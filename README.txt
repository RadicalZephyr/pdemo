...
================================
  ...
  . The installation from the sources supposes that cmake is installed on your
Linux system

  . Unpack the tar compressed file pdip-xxx.tgz into a directory. This will
create a sub-directory called pdip-xxx with the source files of the program:
...
Usage: pdip_install.sh [-d install_root_dir] [-P DEB | RPM] [-B] [-I] [-A] [-h]
  ...
  . Under root identity, launch the installation by passing '-P DEB' and optionnaly '-d' to
  specify an installation directory different than '/usr/local':
...
Usage: pdip_install.sh [-d install_root_dir] [-P DEB | RPM] [-B] [-I] [-A] [-h]
  ...
  . Under root identity, launch the installation by passing '-P RPM' and optionnaly '-d' to
  specify an installation directory different than '/usr/local':
  For example, for a package which will be installed in '/usr/local', type:
